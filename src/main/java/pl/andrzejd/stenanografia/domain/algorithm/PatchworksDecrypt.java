...
public class PatchworksDecrypt implements SteganographyDecrypt {
    @Override
    public float readInformation(BufferedImage image, long seed, int n) {
        return readInformation(image, seed, n, new Random().nextFloat());
    }

    @Override
    public float readInformation(BufferedImage image, long seed, int n, float brightness) {
